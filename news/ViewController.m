...
#import "HLYBigPictureViewController.h"
...
{
    //NSLog(@"%@",imageSrc);
    HLYBigPictureViewController *picVc = [[HLYBigPictureViewController alloc] init];
...
- (void)openVideoPlayer:(NSString *)videoSrc
{
    ...
    HLYVideoPlayerController *videoPlayer = [[HLYVideoPlayerController alloc] init];
